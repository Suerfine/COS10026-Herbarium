...
<html lang="en">
	...
	<body>
		...
		<main class="care-container">
			...
			<!-- EXAMPLE OF SECTION CONTAINING A POINT ON METHOD TO PROTECT YOUR HERBARIUM along with section for image-->
			...
			<!-- EXAMPLE OF ASIDE CONTAINING TIPS ON HOW TO CARE FOR YOUR HERBARIUM -->
			<section id="care-tip-3" class="care-tip">
				...
				<!-- Datalist is used to arrange and explain every material used for mounting -->
				<dl class="care-dl">
					...
					<dd>
						...
						<ul>
							...
							<li><a href="https://www.lineco.com/books-by-hand-ph-neutral-pva-adhesive.html#:~:text=Books%20by%20Hand%20acid%2Dfree,extend%20drying%20time%20if%20desired.">
				...
				<div class="care-tip-figure-wrapper">
					<!-- images of the mounting material are attached along with a link to the supplier for easy purchase bvy the user -->
					<figure class="care-img-figure">
						<img src="images/tutorial/care/adhesive-riceGlue.jpg" alt="Image of adhesive rice glue">
						<figcaption><a href="https://www.lineco.com/belgian-rice-starch.html">
							Belgian rice starch
						</a></figcaption>
					</figure>
					<figure class="care-img-figure">
		...
		<?php 
			$sources=[
				...
				["url"=>"https://www.rbge.org.uk/science-and-conservation/herbarium/specimen-preparation-care/care-and-conservation-of-herbarium-specimens/","label"=>"Care and conservation of specimens & deterioration images"],
				["url"=>"https://eeb.utoronto.ca/research/facilities-centres/green-plant-herbarium/?highlight=green%20herbarium","label"=>"Image of herbarium storage at university of Toronto"],
				["url"=>"https://www.lineco.com/belgian-rice-starch.html","label"=>"Belgian Rice starch image"],
				["url"=>"https://www.dickblick.com/products/lineco-neutral-ph-adhesive/","label"=>"Lineco neutral pH adhesive image"],
				["url"=>"https://www.rbge.org.uk/media/9027/preparation-care-and-art-of-herbarium-specimens-revised-25-oct-2023-ke.pdf","label"=>"RBGE Collections Care:preparation and care of herbarium specimens"],
				["url"=>"https://www.icon.org.uk/","label"=>"The institute of Conservation, ICON"],
